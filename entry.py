...
class Entry():
    ...
    def __init__(self,key):
        self.url = "https://demo.talk-cloud.net/WebAPI/entry"
        self.key = "rcr7J8FM6r9OvARJ"   #authkey值
        self.serial = "551365684"    #房间号
        self.usertype = "0"    #用户类型
        self.domain = "yihuajishi2"   #企业域名
